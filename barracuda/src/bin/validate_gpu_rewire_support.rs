...
//! Exp 057 support: GPU ops 5–8 validation data, benchmarks, and helpers.
//! See `validate_gpu_rewire_benchmark.rs` for the suite entrypoint and high-level docs.
...
pub fn run_gpu_validation(v: &mut ValidationHarness, device: &Arc<WgpuDevice>) {
    let engine =
...
pub fn run_cpu_only_validation(v: &mut ValidationHarness) {
