...
//! Individual benchmark function bodies for CPU vs Python parity testing.
//!
//! Each function takes `n: usize` (iteration count) and returns
//! `(elapsed_secs, result_value, parity_detail_string)`.
