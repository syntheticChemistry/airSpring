...
//! - S87: async fn in dyn trait resolved (edition 2024), FHE shader fixes, `gpu_helpers` refactor, unsafe audit
...
// Historical BarraCuda issues (all resolved) extracted to `resolved_issues` module.
pub use super::resolved_issues::{BARRACUDA_ISSUES, BarraCudaIssue, IssueStatus};
