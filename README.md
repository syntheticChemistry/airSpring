...
| Phase 1: Rust validation | **848 lib + 280 integration** | 91 binaries + 146/146 + 32/32 provenance cross-spring benchmarks (NVK zero-output detection: CPU fallback) |
...
│   └── requirements.txt
├── barracuda/                   # Phase 1+3: Rust validation + GPU dispatch (848 lib tests, 91 binaries, barraCuda 0.3.5 / wgpu 28, Edition 2024)
│   ├── src/
...
Edition 2024 migrated. 848 lib + 280 integration + 61 forge tests, 0 failures.
AGPL-3.0-or-later.*
