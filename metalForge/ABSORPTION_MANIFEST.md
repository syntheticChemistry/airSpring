...
**Date**: March 24, 2026 (updated v0.10.0 — V010 active handoff, forge evolved to mixed hardware dispatch, 27 workloads, 32/32 dispatch + 21/21 routing + 17/17 mixed hardware, barraCuda 0.4.0 wgpu 28, all 20 ops absorbed upstream, zero C deps). metalForge remains active for dispatch routing and CI validation.
...
cargo test  — 62/62 pass (forge), 1,061/1,061 pass (barracuda lib)
