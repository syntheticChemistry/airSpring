...
**Updated**: 2026-03-16 (v0.8.8 — 87 experiments, barraCuda 0.3.5 (wgpu 28), 1284/1284 Python + 880 lib + 285 integration + 61 forge + 381/381 validation + 146/146 cross-spring evolution + 33/33 cross-validation. **14.3× Rust-vs-Python speedup** (24/24 algorithms, 21/21 CPU-GPU parity modules). Ecosystem absorption: zero hardcoded primals, parse_capabilities 4-format, JSON-RPC proptest fuzz (7 properties), PRIMAL_REGISTRY updated, collapsible-if let-chains.)
