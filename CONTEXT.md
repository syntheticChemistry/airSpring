...
- **Lib tests:** 947 (barracuda, with all features)
- **Integration + doc tests:** 306 (barracuda)
- **Barracuda total:** 1,253 (947 lib + 306 integration/doc)
- **Forge tests:** 61 (metalForge)
- **Grand total:** 1,314 (both crates)
