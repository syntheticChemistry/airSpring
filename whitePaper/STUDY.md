...
v0.10.0: niche architecture, Edition 2024, 46 capabilities (method.register + skunkBat IPC + composition.status), 9 UniBin validation scenarios, deep code quality, zero #[allow()]. AGPL-3.0-or-later.*
