...
**Updated**: May 16, 2026 | **Version**: v0.10.0 (Wave 17 Signal Adoption — primal.announce + nest.store/nest.commit, 57 capabilities)
...
| **V0.10.0** | `infra/wateringHole/AIRSPRING_WAVE17_SIGNAL_ADOPTION_MAY16_2026.md` | 2026-05-16 | Wave 17 signal adoption: `primal.announce`, `nest.store`, `nest.commit`, 57 capabilities |
