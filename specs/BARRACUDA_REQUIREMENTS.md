...
**Last Updated**: May 13, 2026 (v0.10.0 — 1,057 lib + 316 integration + 62 forge = 1,435 tests, 94 binaries, 90 experiments, barraCuda 0.4.0 (wgpu 28, DeviceCapabilities API), ops 0-19 upstream via `BatchedElementwiseF64`, `PrecisionRoutingAdvice` wired, 49 capabilities, 7 deploy graphs, guideStone L4 (targeting L6), 10 UniBin validation scenarios, Tier 4 IPC-first `default = []`, Tier 2 IPC wired (toadstool.validate + precision.route). CPU vs Python 25/25 parity incl. Freundlich)
...
### Phase 2: GPU Orchestrators Wired (25 Tier A + 3 pipeline)
...
All algorithms implemented in pure Rust. 1,057 lib tests, 94 binaries, 1,435 total checks.
...
| **Tier 2** (BarraCuda) | Sovereign implementation | **Complete** — 1,057 lib + 316 integration + 62 forge tests, 94 validation binaries |
