...
**Last Updated**: March 19, 2026 (v0.10.0 — 911 lib + 311 integration + 61 forge tests, 97 binaries, 87 experiments, barraCuda 0.3.5 (wgpu 28), ops 0-19 upstream via `BatchedElementwiseF64`, `local_dispatch` retired, `PrecisionRoutingAdvice` wired, upstream provenance registry, 10 MCP tools wired, platform-agnostic IPC. Exp 084: CPU/GPU parity 21/21, Exp 085: toadStool dispatch 19/19)
