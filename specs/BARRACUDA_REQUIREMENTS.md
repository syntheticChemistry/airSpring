...
**Last Updated**: March 16, 2026 (v0.8.7 — 863 lib + 61 forge tests, 91 binaries, 87 experiments, barraCuda 0.3.5 (wgpu 28), ops 0-19 upstream via `BatchedElementwiseF64`, `local_dispatch` retired, `PrecisionRoutingAdvice` wired, upstream provenance registry. Exp 084: CPU/GPU parity 21/21, Exp 085: toadStool dispatch 19/19)
...
| **Tier 2** (BarraCuda) | Sovereign implementation | **Complete** — 863 lib + 61 forge tests, 91 validation binaries |
