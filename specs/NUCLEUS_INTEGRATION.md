...
**Invariant:** 1,027 Rust lib tests + 46/46 GPU math + 75/75 cross-validation + 1393 atlas must pass regardless of deployment mode
...
airSpring (Spring — validation consumer)
    ...
    │
    ├── barracuda/ (Rust validation, 1,027 lib tests, 94 binaries)
    │       │
...
5. **Validation invariant**: All 1,027 Rust lib tests + 46/46 GPU math portability + 1393 atlas checks must pass regardless of deployment mode
