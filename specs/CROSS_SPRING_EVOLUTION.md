...
**Updated**: May 17, 2026 (v0.10.0, 1,057 lib + 316 integration + 69 forge = 1,442 tests, barraCuda 0.4.0 / wgpu 28, 90 experiments, Tier 4 IPC-first)
...
v0.10.0: **25 Tier A** orchestrators (ops 0-19 all upstream), **1,057** lib + 316 integration + 69 forge = **1,442** tests, 94 binaries.
