...
**Updated**: May 13, 2026 (v0.10.0, 1,057 lib + 316 integration + 62 forge = 1,435 tests, barraCuda 0.4.0 / wgpu 28, 90 experiments, Tier 4 IPC-first)
...
v0.10.0: **25 Tier A** orchestrators (ops 0-19 all upstream), **1,057** lib + 316 integration + 62 forge = **1,435** tests, 94 binaries.
