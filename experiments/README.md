...
|----------|:-----:|--------|
| Barracuda lib | 1,051 | `cargo test --features local,testutil --lib` |
...
| **Total project tests** | **1,429** (1,051 lib + 316 integration + 62 forge) | |
