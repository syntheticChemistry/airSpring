...
|----------|:-----:|--------|
| Barracuda lib | 1,035 | `cargo test --features local,testutil --lib` |
...
| **Total project tests** | **1,413** (1,035 lib + 316 integration + 62 forge) | |
