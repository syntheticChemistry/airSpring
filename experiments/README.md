...
| **Total project tests** | **1,435** (1,057 lib + 316 integration + 62 forge) | |
...
| CPU vs Python parity | 25/25 | `bench_cpu_vs_python` (14.3× geometric mean speedup) |
