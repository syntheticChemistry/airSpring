...
|----------|:-----:|--------|
| Barracuda lib | 1,061 | `cargo test --features local,testutil --lib` |
...
| **Total project tests** | **1,446** (1,061 lib + 316 integration + 69 forge) | |
