...
**Status**: 90 experiments, barraCuda 0.4.0 (wgpu 28), v0.10.0, Edition 2024 (MSRV 1.92). 1284/1284 Python + 1,057 lib + 316 integration + 69 forge = 1,442 total. 98 binaries. 57 registered / 46 live capabilities. 474-method canonical registry sync (Wave 60). eastGate operational (12/12 NUCLEUS + airspring cell, plasmidBin-only).
